...
Elm.EventTicker.make = function (_elm) {
   "use strict";
   _elm.EventTicker = _elm.EventTicker || {};
   if (_elm.EventTicker.values)
...
Elm.GithubEvent.make = function (_elm) {
   "use strict";
   _elm.GithubEvent = _elm.GithubEvent || {};
   if (_elm.GithubEvent.values)
   ...
   var EventActor = F2(function (a,
   b) {
      return {_: {}
             ,avatar_url: b
             ,login: a};
   });
   var githubEventActor = A3($Json$Decode.object2,
   EventActor,
   A2($Json$Decode._op[":="],
   "login",
   $Json$Decode.string),
   ...
   "avatar_url",
   $Json$Decode.string));
   var listDecoder = $Json$Decode.list(A4($Json$Decode.object3,
   Event,
   A2($Json$Decode._op[":="],
   "type",
   $Json$Decode.string),
...
Elm.SeeThePeople = Elm.SeeThePeople || {};
Elm.SeeThePeople.make = function (_elm) {
   "use strict";
   _elm.SeeThePeople = _elm.SeeThePeople || {};
   if (_elm.SeeThePeople.values)
   return _elm.SeeThePeople.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
...
Elm.Sydron = Elm.Sydron || {};
Elm.Sydron.make = function (_elm) {
   "use strict";
   _elm.Sydron = _elm.Sydron || {};
   if (_elm.Sydron.values)
